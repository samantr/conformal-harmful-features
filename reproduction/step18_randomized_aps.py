...
# ============================================================
# STEP 18 — STANDARD RANDOMIZED APS
#
# IMPORTANT:
# - ConfTS optimization still uses NON-RANDOMIZED APS.
# - Only the final conformal calibration + prediction sets
#   use STANDARD RANDOMIZED APS.
# ============================================================
...
# ============================================================
# 13. Standard conformal threshold
# ============================================================
...
# ============================================================
# 17. Ordinary Temperature Scaling
...
# ============================================================
# 28. FINAL STEP-18 COMPARISON
#
# ECE is a property of probabilities, so randomization does
# NOT affect ECE.
#
# Coverage / Average Size below are STANDARD RANDOMIZED APS.
# ============================================================
...
print("\n================ FINAL STEP 18 RESULTS ================")
print(
    "Method                 T        ECE       "
    "Coverage    Avg Size    Tau       Empty"
)
print(
    "--------------------------------------------------------------------------"
)
...
print("\n================ STEP 18 REMINDER ================")
print("ConfTS optimization: NON-RANDOMIZED APS")
print("Final conformal predictor: RANDOMIZED APS")
